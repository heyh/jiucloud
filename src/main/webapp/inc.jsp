...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jslib/base64.js"
	charset="utf-8"></script>
<!-- ck -->
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jslib/ckeditor/ckeditor.js"
	charset="utf-8"></script>

<!-- webIM -->
<script type='text/javascript'
	src='${pageContext.request.contextPath}/jslib/webIM/strophe-custom-1.0.0.js'></script>
<script type='text/javascript'
	src='${pageContext.request.contextPath}/jslib/webIM/json2.js'></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jslib/webIM/easemob.im-1.0.4.js"></script>
