...
parent.$.messager.progress('close');
    ...
    $(function () {
        $('#form')
                .form(
                        {
                            url: '${pageContext.request.contextPath}/fieldDataController/securi_materialsExeclImport',
    ...
    <form class="form-inline" role="form" id="form" method="post" enctype="multipart/form-data">
        ...
        <table class="table_style">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-mini btn-success" onclick="window.location.href='http://gcgl.9393915.com:8080/fileserver/template/<%= userId %>/materialsTemplate.xls'">下载模版</a>
                </td>
            </tr>
        </table>
    </form>
