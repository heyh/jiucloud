...
<script>
    ...
    $(function() {
        ...
        dataGrid4Data = $('#dataGrid4Data')
            .datagrid(
                {
                    url : '${pageContext.request.contextPath}/fieldDataController/securi_approveMonitorDataGrid?source=data',
                    fit : true,
                    fitColumns : false,
                    border : true,
                    pagination : true,
                    ...
                    columns : [ [
                        ...
                        },
                        {
                            ...
                            formatter : function(value, row, index) {
                                ...
                                str += $
                                    .formatString(
                                        ' <img onclick="FileFun(\'{0}\');" src="{1}" title="查看附件"/>',
                                        row.id,
        ...
        dataGrid4Doc = $('#dataGrid4Doc')
            .datagrid(
                {
                    url : '${pageContext.request.contextPath}/fieldDataController/securi_approveMonitorDataGrid?source=doc',
                    fit : true,
                    fitColumns : false,
                    border : true,
                    pagination : true,
        ...
        dataGrid4Bill= $('#dataGrid4Bill')
            .datagrid(
                {
                    url : '${pageContext.request.contextPath}/fieldDataController/securi_approveMonitorDataGrid?source=bill',
                    fit : true,
                    fitColumns : false,
                    border : true,
                    pagination : true,
        ...
        dataGrid4Material = $('#dataGrid4Material')
            .datagrid(
                {
                    url : '${pageContext.request.contextPath}/fieldDataController/securi_approveMonitorDataGrid?source=material',
                    fit : true,
                    fitColumns : false,
                    border : true,
                    pagination : true,
