		...
		$('#form').form({
			...
			onSubmit : function() {
				...
				for (var i = 1; i < 11; i++) {
					...
					$('#data' + i).val($('#data' + i).val() + ' 00:00:00');
				}
				return isValid;
			},
	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed"
				...
				<tr>
					<td>建筑面积或规模值</td>
					<td><input type="text" name="jzmjorgm" /></td>
					<td>工程合同价</td>
					<td><input type="text" name="gchtj" /></td>
					<td>投标项目经理</td>
					<td><input type="text" name="manager2" /></td>
				</tr>
				<tr>
					<td>合同签订日期</td>
				...
				<tr>
					<td>工程质保约定</td>
					<td><input type="text" name="gczbyd" /></td>
					<td>工程付款约定</td>
					<td><input type="text" name="gcfkyd" /></td>
					<td>中标通知书日期</td>
				...
				<tr>
					...
					</select> <select id="city" name="city" style='width: 85px'>
					</select></td>
					<td>工程款支付状态</td>
					<td><input type="text" name="money_state" /></td>
				</tr>
				...
				<tr>
					...
					<td>工程到期移交情况</td>
					<td><input type="text" name="gcdqyjqk" /></td>
					<td>工程质量获奖情况</td>
					<td><input type="text" name="gczlhjqk" /></td>
				</tr>
				<tr>
					<td>竣工结算书</td>
					<td><input type="text" name="jgjss" /></td>
					<td>工程安全文明情况</td>
					<td><input type="text" name="gcaqwmqk" /></td>
					<td>竣工报告</td>
					<td><input type="text" name="jgbb" /></td>
				</tr>
				<tr>
					<td>正式开工日期</td>
				...
				<tr>
					<td>竣工资料</td>
					<td><input type="text" name="jgzl" /></td>
					<td>资料员</td>
					<td><input type="text" name="zly" /></td>
					<td>造价员</td>
					<td><input type="text" name="zjy" /></td>
				</tr>
				<tr>
					<td>维(养)护开始时间</td>
				...
				<tr>
					<td>工程维(养)护期</td>
					<td><input type="text" name="gcwhq" /></td>
					<td>维(养)护级别</td>
					<td><input type="text" name="yhjb" /></td>
					<td>维(养)护承包人</td>
					<td><input type="text" name="yhcbr" /></td>
				</tr>
			</table>
		</form>
	</div>
