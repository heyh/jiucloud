		...
		<form id="form" method="post" enctype="multipart/form-data">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<td>
						<input style="width: 360px;" name="title" type="text" placeholder="请输入标题名称" class="easyui-validatebox span2" data-options="required:true" value="">
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<span id="time" style="display: none;line-height: ">
							 <input name="time1"  id="time1" class="Wdate"   onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm'})" readonly="readonly"/>
						</span>
					</td>
				</tr>
				<tr style="height: 99px;">
					...
					<td>
						<input type="text" style="width: 360px;" name="picPath" id="picPath" value="" readonly="readonly">
						<br/>
				...
				<tr>
					...
					<td>
						<textarea name="content" id="content" placeholder="请输入内容" style="width:300px;height:130px;" class="easyui-validatebox span2"></textarea>
					</td>
				</tr>
			</table>
		</form>
