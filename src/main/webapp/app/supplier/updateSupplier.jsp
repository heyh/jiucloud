...
<script type="text/javascript">
    $(function () {
        ...
        $('#form')
            .form(
                {
                    url: '${pageContext.request.contextPath}/supplierController/securi_update',
                    onSubmit: function () {
                        if ($('#name').val() == '') {
                            alert('请填写供应商名称');
                            return false;
    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;">
        <form class="form-horizontal" name="form" id="form" method="post" role="form" style="padding-right: 100px">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="tel" name="tel" value="${supplier.tel}" required>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="addr" name="addr" value="${supplier.addr}">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="linkman">联系人:</label>
                <div class="controls">
                    <input type="text" id="linkman" name="linkman" value="${supplier.linkman}" required>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="linkphone">联系电话:</label>
                <div class="controls">
                    <input type="text" id="linkphone" name="linkphone" value="${supplier.linkphone}" required>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="remark">备注:</label>
                <div class="controls">
                    <textarea type="text" name="remark" id="remark" style="width: 220px">${supplier.remark}</textarea>
                </div>
            </div>
        </form>
    </div>
