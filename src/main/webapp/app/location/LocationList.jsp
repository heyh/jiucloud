...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/locationController/securi_dataGrid',
							fit : true,
							fitColumns : true,
							border : false,
							pagination : true,
                ...
                function(b) {
                    if (b) {
                        ...
                        $
                            .ajax({
                                type : "post",
                                url : '${pageContext.request.contextPath}/locationController/securi_delLocation',
                                data : {
                                    id : id,
									cid: <%= cid %>,
									uid: <%= uid %>
                ...
                .confirm(
                    ...
                    function(r) {
                        if (r) {
                            ...
                            $
                                .getJSON(
                                    '${pageContext.request.contextPath}/locationController/securi_bunchdelete?',
                                    {
                                        ids : ids.join(',')
                                    },
                                    function(result) {
    ...
    function editFun(id) {
        parent.$
            .modalDialog({
                ...
                width: 500,
                height: 200,
                href: '${pageContext.request.contextPath}/locationController/securi_updatePage?id=' + id,
                buttons: [{
                    text: '修改',
                    handler: function () {
	...
	function addFun() {
        parent.$
            .modalDialog({
                ...
                width: 500,
                height: 200,
                href: '${pageContext.request.contextPath}/locationController/securi_addPage',
                buttons: [{
                    text: '新增',
                    handler: function () {
                        parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
