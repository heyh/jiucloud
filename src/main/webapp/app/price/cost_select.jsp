...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/priceController/securi_costList?price_id='
									+ $('#price_id').val(),
							fit : true,
							fitColumns : true,
							border : false,
					...
					.confirm(
							...
							function(r) {
								if (r) {
									...
									$
											.getJSON(
													'${pageContext.request.contextPath}/priceController/securi_addcost?',
													{
														ids : ids.join(','),
														price_id : $(
																'#price_id')
			...
			<table class="table table-hover table-condensed"
				...
				<tr>
					<td style="text-align: left; width: 80px;"><input
						type="hidden" id='price_id' name='price_id' value='${price_id}'>费用类型:&nbsp;&nbsp;</td>
