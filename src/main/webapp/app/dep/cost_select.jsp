...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/costController/securi_department_costList?department_id='
									+ $('#department_id').val(),
							fit : true,
							fitColumns : true,
							border : false,
					...
					.confirm(
							...
							function(r) {
								if (r) {
									...
									$
											.getJSON(
													'${pageContext.request.contextPath}/costController/securi_addcost?',
													{
														ids : ids.join(','),
														department_id : $(
																'#department_id')
	...
	<div data-options="region:'north',title:'查询条件',border:false"
		...
		<form id="searchForm">
			<table class="table table-hover table-condensed"
				style="display: none;">
				<tr>
					<td style="text-align: left; width: 80px;"><input
						type="hidden" id='department_id' name='department_id' value='${department_id}'>费用类型:&nbsp;&nbsp;</td>
