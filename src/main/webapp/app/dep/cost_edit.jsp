...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/costController/securi_department_list?department_id='
									+ $('#department_id').val(),
							fit : true,
							fitColumns : true,
							border : false,
					...
					.confirm(
							...
							function(r) {
								if (r) {
									...
									$
											.getJSON(
													'${pageContext.request.contextPath}/costController/securi_deletecost?',
													{
														ids : ids.join(','),
														department_id : $(
																'#department_id')
			...
			<table class="table table-hover table-condensed"
				...
				<tr>
					<td style="text-align: left"><input type="hidden"
						id='department_id' name='department_id' value='${department_id}'>费用类型:&nbsp;&nbsp;</td>
