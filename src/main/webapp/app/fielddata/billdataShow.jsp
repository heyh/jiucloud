...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid')
				.datagrid(
						{
							url : '${pageContext.request.contextPath}/fieldDataController/dataGrid?source=bill',
							fit : true,
							fitColumns : false,
							border : false,
							pagination : true,
...
//									},
	...
	// 添加
	function addFun() {
		var url = '${pageContext.request.contextPath}/fieldDataController/securi_addBillData';
		var text = "添加清单项量";
		var params = {
			url : url,
			title : text,
