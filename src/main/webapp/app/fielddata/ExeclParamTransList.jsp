    ...
    <script type="text/javascript">
        ...
        $(function () {
            dataGrid = $('#dataGrid')
                .datagrid(
                    {
                        url: '${pageContext.request.contextPath}/paramTransController/securi_execlDataGrid',
                        fit: true,
                        fitColumns: true,
                        border: false,
                        pagination: true,
        ...
        function editFun(id) {
            parent.$
                .modalDialog({
                    ...
                    width: 460,
                    height: 300,
                    href: '${pageContext.request.contextPath}/paramTransController/securi_updateExeclParamTransPage?id=' + id,
                    buttons: [{
                        text: '修改',
                        handler: function () {
        ...
        function addFun() {
            parent.$
                .modalDialog({
                    ...
                    width: 460,
                    height: 300,
                    href: '${pageContext.request.contextPath}/paramTransController/securi_addExeclParamTransPage',
                    buttons: [{
                        text: '新增',
                        handler: function () {
                            parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
        ...
        function uploadFun() {
            parent.$
                .modalDialog({
                    ...
                    width: 400,
                    height: 150,
                    href: '${pageContext.request.contextPath}/paramTransController/securi_uploadExeclTemplatePage',
                    buttons: [{
                        text: '上传',
                        handler: function () {
                            parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
...
<div id="toolbar" style="display: none;padding: 5px">
    ...
    <a onclick="uploadFun();" href="javascript:void(0);"
       class="easyui-linkbutton"
       data-options="plain:true,iconCls:'upload_new'">上传模板</a>
