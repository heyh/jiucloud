...
//public class FieldDataControllerbak extends BaseController {
//
//    @Autowired
...
//    @ResponseBody
//    public String zjsprojectTreeGrid(HttpServletRequest request) {
//        SessionInfo sessionInfo = (SessionInfo) request.getSession()
//                .getAttribute(ConfigUtil.getSessionInfoName());
//        String keyword = StringUtil.trimToEmpty(request.getParameter("keyword"));
//        List<Integer> ugroup = sessionInfo.getUgroup();
...
//        List<JswZjsproject> jswZjsprojectList = (List<JswZjsproject>) jswZjsprojectService.dataGrid(ugroup, keyword, startTime, endTime).getRows();
//
//        for (JswZjsproject jswZjsproject : jswZjsprojectList) {
//            _zjsproject = new JSONObject();
...
//            _zjsproject.put("zjsdwgcBh", jswZjsproject.getZjsdwgcBh());
//            _zjsprojectList.put(_zjsproject);
//        }
//
//        return _zjsprojectList.toString();
//    }
//
...
//            List<Map<String, Object>> summaryInfos = SqliteHelper.query(mdbPath, "select ID,FEENAME VARNAME,FEERESULT VARRESULT from SUMMARY");
...
//                    if (costTransInfo.getParamName().equals(jswCostName)) {
//
