...
public class ResourceServiceImpl implements ResourceServiceI {
	...
	public List<Tree> tree(SessionInfo sessionInfo) {
		...
		// // l =
		// //
		// resourceDao.find("select distinct t from Tresource t join fetch t.tresourcetype type join fetch t.troles role join role.tusers user where type.id = :resourceTypeId and user.id = :userId order by t.seq",params);
		// l = resourceDao
		...
		// } else {
		l = resourceDao
				.find("from Tresource t join fetch t.tresourcetype type where type.id = :resourceTypeId order by t.seq",
						params);
		// }
